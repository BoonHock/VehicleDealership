namespace VehicleDealership.View
{
    ...
    "s.";
			...
			this.expensesToolStripMenuItem.Text = "Vehicle Expenses";
			this.expensesToolStripMenuItem.Click += new System.EventHandler(this.VehicleExpensesToolStripMenuItem_Click);
			// 
