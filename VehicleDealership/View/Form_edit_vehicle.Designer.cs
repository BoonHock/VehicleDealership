...
{
	partial class Form_edit_vehicle
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.table_finance = new System.Windows.Forms.TableLayoutPanel();
			...
			this.table_acquire_details = new System.Windows.Forms.TableLayoutPanel();
			...
			this.txt_prev_reg_no = new System.Windows.Forms.TextBox();
			...
			this.tabpage_loan_details = new System.Windows.Forms.TabPage();
			...
			this.cms_payment = new System.Windows.Forms.ContextMenuStrip(this.components);
			...
			this.toolstrip_payment_to_seller = new System.Windows.Forms.ToolStrip();
			...
			this.cms_expenses = new System.Windows.Forms.ContextMenuStrip(this.components);
			this.addExpensesToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.editExpensesToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.deleteExpensesToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			this.toolstrip_expenses = new System.Windows.Forms.ToolStrip();
			...
			this.toolstrip_file_attachment = new System.Windows.Forms.ToolStrip();
			...
			this.btn_download_attachment = new System.Windows.Forms.ToolStripButton();
			...
			this.table_finance.SuspendLayout();
			...
			this.table_acquire_details.SuspendLayout();
			...
			this.table_vehicle_details.SuspendLayout();
			...
			this.tabpage_loan_details.SuspendLayout();
			...
			this.cms_payment.SuspendLayout();
			this.toolstrip_payment_to_seller.SuspendLayout();
			this.groupBox1.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.grd_expenses)).BeginInit();
			this.cms_expenses.SuspendLayout();
			this.toolstrip_expenses.SuspendLayout();
			...
			this.toolstrip_file_attachment.SuspendLayout();
			...
			this.tabControl1.Controls.Add(this.tabpage_loan_details);
			...
			// tabpage_home
			// 
			this.tabpage_home.Controls.Add(this.groupBox10);
			this.tabpage_home.Controls.Add(this.groupBox9);
			this.tabpage_home.Controls.Add(this.groupBox11);
			this.tabpage_home.Controls.Add(this.txt_status);
			this.tabpage_home.Controls.Add(this.label82);
			this.tabpage_home.Controls.Add(this.txt_last_modified_on);
			this.tabpage_home.Controls.Add(this.label83);
			this.tabpage_home.Controls.Add(this.label84);
			this.tabpage_home.Controls.Add(this.txt_ref_no);
			this.tabpage_home.Controls.Add(this.txt_last_modified_by);
			this.tabpage_home.Controls.Add(this.label85);
			this.tabpage_home.Controls.Add(this.dtp_settle_by);
			this.tabpage_home.Controls.Add(this.label2);
			this.tabpage_home.Location = new System.Drawing.Point(4, 26);
			this.tabpage_home.Name = "tabpage_home";
			this.tabpage_home.Padding = new System.Windows.Forms.Padding(3);
			this.tabpage_home.Size = new System.Drawing.Size(935, 546);
			this.tabpage_home.TabIndex = 7;
			this.tabpage_home.Text = "Home";
			this.tabpage_home.UseVisualStyleBackColor = true;
			// 
			// groupBox10
			// 
			this.groupBox10.Controls.Add(this.table_finance);
			...
			// table_finance
			// 
			this.table_finance.ColumnCount = 4;
			this.table_finance.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_finance.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.table_finance.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_finance.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.table_finance.Controls.Add(this.num_purchase_price, 1, 0);
			this.table_finance.Controls.Add(this.label56, 0, 0);
			this.table_finance.Controls.Add(this.num_net_purchase, 1, 2);
			this.table_finance.Controls.Add(this.label59, 0, 2);
			this.table_finance.Controls.Add(this.label60, 0, 1);
			this.table_finance.Controls.Add(this.num_overtrade, 1, 1);
			this.table_finance.Controls.Add(this.num_to_pay, 1, 5);
			this.table_finance.Controls.Add(this.label86, 0, 5);
			this.table_finance.Controls.Add(this.num_paid, 1, 4);
			this.table_finance.Controls.Add(this.label64, 0, 4);
			this.table_finance.Controls.Add(this.num_loan_balance_readonly, 1, 3);
			this.table_finance.Controls.Add(this.label63, 0, 3);
			this.table_finance.Controls.Add(this.label58, 2, 0);
			this.table_finance.Controls.Add(this.num_expenses, 3, 0);
			this.table_finance.Controls.Add(this.num_total_cost, 3, 1);
			this.table_finance.Controls.Add(this.label57, 2, 1);
			this.table_finance.Controls.Add(this.label61, 2, 2);
			this.table_finance.Controls.Add(this.num_max_can_loan, 3, 5);
			this.table_finance.Controls.Add(this.label1, 2, 5);
			this.table_finance.Controls.Add(this.num_gross_profit, 3, 4);
			this.table_finance.Controls.Add(this.label62, 2, 4);
			this.table_finance.Controls.Add(this.num_list_price, 3, 2);
			this.table_finance.Controls.Add(this.num_expenses_charged, 3, 3);
			this.table_finance.Controls.Add(this.label3, 2, 3);
			this.table_finance.Dock = System.Windows.Forms.DockStyle.Fill;
			this.table_finance.Location = new System.Drawing.Point(3, 21);
			this.table_finance.Name = "table_finance";
			this.table_finance.RowCount = 7;
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_finance.Size = new System.Drawing.Size(545, 180);
			this.table_finance.TabIndex = 0;
			// 
			// num_purchase_price
			// 
			this.num_purchase_price.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.num_purchase_price.DecimalPlaces = 2;
			...
			this.num_overtrade.DecimalPlaces = 2;
			...
			this.num_to_pay.DecimalPlaces = 2;
			this.num_to_pay.Enabled = false;
			this.num_to_pay.Location = new System.Drawing.Point(144, 147);
			...
			this.label86.Location = new System.Drawing.Point(3, 151);
			this.label86.Name = "label86";
			this.label86.Size = new System.Drawing.Size(110, 17);
			this.label86.TabIndex = 2;
			this.label86.Text = "F. To pay (C-D-E):";
			// 
			// num_paid
			// 
			...
			this.num_paid.Location = new System.Drawing.Point(144, 118);
			...
			this.num_paid.ValueChanged += new System.EventHandler(this.Recalculate_nums);
			// 
			// label64
			// 
			this.label64.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.label64.AutoSize = true;
			this.label64.Location = new System.Drawing.Point(3, 122);
			this.label64.Name = "label64";
			this.label64.Size = new System.Drawing.Size(50, 17);
			this.label64.TabIndex = 2;
			this.label64.Text = "E. Paid:";
			// 
			// num_loan_balance_readonly
			// 
			this.num_loan_balance_readonly.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.num_loan_balance_readonly.DecimalPlaces = 2;
			this.num_loan_balance_readonly.Enabled = false;
			this.num_loan_balance_readonly.Location = new System.Drawing.Point(144, 89);
			...
			this.label63.Location = new System.Drawing.Point(3, 93);
			this.label63.Name = "label63";
			this.label63.Size = new System.Drawing.Size(104, 17);
			this.label63.TabIndex = 2;
			this.label63.Text = "D. Loan balance:";
			// 
			// label58
			// 
			...
			this.num_expenses.ValueChanged += new System.EventHandler(this.Recalculate_nums);
			// 
			// num_total_cost
			// 
			...
			// groupBox9
			// 
			this.groupBox9.Controls.Add(this.table_acquire_details);
			...
			// 
			// table_acquire_details
			// 
			this.table_acquire_details.ColumnCount = 4;
			this.table_acquire_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_acquire_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.table_acquire_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_acquire_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_acquire_details.Controls.Add(this.label47, 0, 0);
			this.table_acquire_details.Controls.Add(this.btn_seller, 2, 0);
			this.table_acquire_details.Controls.Add(this.txt_seller_name, 1, 0);
			this.table_acquire_details.Controls.Add(this.label49, 0, 3);
			this.table_acquire_details.Controls.Add(this.txt_invoice_no, 1, 3);
			this.table_acquire_details.Controls.Add(this.txt_checked_by, 1, 2);
			this.table_acquire_details.Controls.Add(this.label54, 0, 2);
			...
			this.table_acquire_details.RowCount = 10;
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			...
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_acquire_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_acquire_details.Size = new System.Drawing.Size(357, 239);
			this.table_acquire_details.TabIndex = 27;
			// 
			// label47
			// 
			...
			this.txt_checked_by.TabIndex = 4;
			// 
			// label54
			// 
			...
			this.btn_checked_by.TabIndex = 5;
			...
			// lbl_sale_order
			// 
			this.lbl_sale_order.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.lbl_sale_order.AutoSize = true;
			this.lbl_sale_order.Location = new System.Drawing.Point(3, 211);
			this.lbl_sale_order.Name = "lbl_sale_order";
			this.lbl_sale_order.Size = new System.Drawing.Size(80, 17);
			this.lbl_sale_order.TabIndex = 22;
			this.lbl_sale_order.Text = "Sale ref. no.:";
			// 
			// txt_sale_order
			// 
			this.txt_sale_order.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			this.txt_sale_order.Location = new System.Drawing.Point(101, 207);
			this.txt_sale_order.Margin = new System.Windows.Forms.Padding(2);
			this.txt_sale_order.Name = "txt_sale_order";
			this.txt_sale_order.ReadOnly = true;
			this.txt_sale_order.Size = new System.Drawing.Size(224, 25);
			this.txt_sale_order.TabIndex = 13;
			// 
			// btn_sales_order
			// 
			...
			this.btn_sales_order.TabIndex = 14;
			...
			this.num_checked_by_id.TabIndex = 7;
			...
			this.txt_seller_type.TabIndex = 9;
			this.txt_seller_type.Visible = false;
			// 
			// num_sale
			// 
			this.num_sale.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.num_sale.Location = new System.Drawing.Point(329, 178);
			this.num_sale.Margin = new System.Windows.Forms.Padding(2);
			this.num_sale.Maximum = new decimal(new int[] {
            1000000000,
            0,
            0,
            0});
			this.num_sale.Name = "num_sale";
			this.num_sale.Size = new System.Drawing.Size(26, 25);
			this.num_sale.TabIndex = 12;
			...
			// groupBox11
			// 
			this.groupBox11.Controls.Add(this.table_vehicle_details);
			...
			// 
			this.table_vehicle_details.ColumnCount = 7;
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 100F));
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle());
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 151F));
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 168F));
			this.table_vehicle_details.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 139F));
			this.table_vehicle_details.Controls.Add(this.label66, 0, 0);
			this.table_vehicle_details.Controls.Add(this.label74, 0, 5);
			this.table_vehicle_details.Controls.Add(this.txt_reg_no, 1, 0);
			this.table_vehicle_details.Controls.Add(this.btn_vehicle_location, 2, 5);
			this.table_vehicle_details.Controls.Add(this.label80, 0, 2);
			this.table_vehicle_details.Controls.Add(this.txt_vehicle_model, 1, 2);
			this.table_vehicle_details.Controls.Add(this.btn_vehicle_model, 2, 2);
			this.table_vehicle_details.Controls.Add(this.txt_vehicle_group, 1, 3);
			this.table_vehicle_details.Controls.Add(this.label81, 0, 3);
			this.table_vehicle_details.Controls.Add(this.num_road_tax_amount, 6, 5);
			this.table_vehicle_details.Controls.Add(this.label71, 5, 5);
			this.table_vehicle_details.Controls.Add(this.txt_vehicle_location, 1, 5);
			this.table_vehicle_details.Controls.Add(this.dtp_road_tax_expiry, 6, 4);
			this.table_vehicle_details.Controls.Add(this.label4, 0, 1);
			this.table_vehicle_details.Controls.Add(this.txt_prev_reg_no, 1, 1);
			this.table_vehicle_details.Controls.Add(this.label73, 5, 4);
			this.table_vehicle_details.Controls.Add(this.txt_vehicle_brand, 1, 4);
			this.table_vehicle_details.Controls.Add(this.label87, 0, 4);
			this.table_vehicle_details.Controls.Add(this.num_vehicle_model_id, 2, 1);
			this.table_vehicle_details.Controls.Add(this.num_vehicle_location, 2, 4);
			this.table_vehicle_details.Controls.Add(this.dtp_registered, 6, 3);
			this.table_vehicle_details.Controls.Add(this.label69, 5, 3);
			this.table_vehicle_details.Controls.Add(this.flowLayoutPanel2, 6, 2);
			this.table_vehicle_details.Controls.Add(this.label72, 5, 2);
			this.table_vehicle_details.Controls.Add(this.cmb_vehicle_colour, 6, 1);
			this.table_vehicle_details.Controls.Add(this.label77, 5, 1);
			this.table_vehicle_details.Controls.Add(this.num_mileage, 6, 0);
			this.table_vehicle_details.Controls.Add(this.label75, 5, 0);
			this.table_vehicle_details.Controls.Add(this.txt_door_key, 4, 5);
			this.table_vehicle_details.Controls.Add(this.label76, 3, 5);
			this.table_vehicle_details.Controls.Add(this.txt_ignition_key, 4, 4);
			this.table_vehicle_details.Controls.Add(this.label78, 3, 4);
			this.table_vehicle_details.Controls.Add(this.num_engine_cc, 4, 3);
			this.table_vehicle_details.Controls.Add(this.label70, 3, 3);
			this.table_vehicle_details.Controls.Add(this.txt_engine_no, 4, 2);
			this.table_vehicle_details.Controls.Add(this.label68, 3, 2);
			this.table_vehicle_details.Controls.Add(this.txt_year_make, 4, 1);
			this.table_vehicle_details.Controls.Add(this.label79, 3, 1);
			this.table_vehicle_details.Controls.Add(this.txt_chassis, 4, 0);
			this.table_vehicle_details.Controls.Add(this.label67, 3, 0);
			this.table_vehicle_details.Dock = System.Windows.Forms.DockStyle.Fill;
			this.table_vehicle_details.Location = new System.Drawing.Point(3, 21);
			this.table_vehicle_details.Name = "table_vehicle_details";
			this.table_vehicle_details.RowCount = 7;
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.RowStyles.Add(new System.Windows.Forms.RowStyle());
			this.table_vehicle_details.Size = new System.Drawing.Size(917, 179);
			this.table_vehicle_details.TabIndex = 35;
			// 
			// label66
			// 
			...
			this.label74.Location = new System.Drawing.Point(3, 154);
			...
			this.btn_vehicle_location.Location = new System.Drawing.Point(348, 150);
			...
			this.txt_vehicle_model.Location = new System.Drawing.Point(161, 61);
			...
			this.txt_vehicle_model.Size = new System.Drawing.Size(182, 25);
			this.txt_vehicle_model.TabIndex = 2;
			// 
			// btn_vehicle_model
			// 
			this.btn_vehicle_model.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.btn_vehicle_model.Location = new System.Drawing.Point(348, 61);
			...
			this.txt_vehicle_group.Location = new System.Drawing.Point(161, 91);
			...
			this.txt_vehicle_group.Size = new System.Drawing.Size(182, 25);
			...
			this.label81.Location = new System.Drawing.Point(3, 95);
			...
			this.num_road_tax_amount.Location = new System.Drawing.Point(780, 150);
			...
			this.label71.Location = new System.Drawing.Point(613, 154);
			...
			this.txt_vehicle_location.Location = new System.Drawing.Point(161, 150);
			...
			this.txt_vehicle_location.Size = new System.Drawing.Size(182, 25);
			...
			this.dtp_road_tax_expiry.Location = new System.Drawing.Point(780, 120);
			...
			this.label4.Text = "Previous registration no.:";
			// 
			// txt_prev_reg_no
			// 
			this.txt_prev_reg_no.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Left | System.Windows.Forms.AnchorStyles.Right)));
			this.txt_prev_reg_no.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			this.txt_prev_reg_no.Location = new System.Drawing.Point(161, 31);
			this.txt_prev_reg_no.Margin = new System.Windows.Forms.Padding(2);
			this.txt_prev_reg_no.MaxLength = 10;
			this.txt_prev_reg_no.Name = "txt_prev_reg_no";
			this.txt_prev_reg_no.Size = new System.Drawing.Size(182, 25);
			this.txt_prev_reg_no.TabIndex = 1;
			this.txt_prev_reg_no.Enter += new System.EventHandler(this.Txt_reg_no_Enter);
			this.txt_prev_reg_no.Leave += new System.EventHandler(this.Txt_reg_no_Leave);
			// 
			// label73
			// 
			this.label73.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.label73.AutoSize = true;
			this.label73.Location = new System.Drawing.Point(613, 124);
			...
			this.txt_vehicle_brand.Location = new System.Drawing.Point(161, 120);
			...
			this.txt_vehicle_brand.Size = new System.Drawing.Size(182, 25);
			...
			this.label87.Location = new System.Drawing.Point(3, 124);
			...
			this.num_vehicle_model_id.Location = new System.Drawing.Point(347, 31);
			...
			this.num_vehicle_model_id.TabIndex = 2;
			...
			this.num_vehicle_location.Location = new System.Drawing.Point(347, 120);
			...
			this.num_vehicle_location.TabIndex = 7;
			...
			this.dtp_registered.Location = new System.Drawing.Point(780, 91);
			...
			this.label69.Location = new System.Drawing.Point(613, 95);
			...
			this.flowLayoutPanel2.Location = new System.Drawing.Point(780, 60);
			...
			this.label72.Location = new System.Drawing.Point(613, 65);
			...
			this.cmb_vehicle_colour.Location = new System.Drawing.Point(780, 33);
			...
			this.label77.Location = new System.Drawing.Point(613, 35);
			...
			this.num_mileage.Location = new System.Drawing.Point(780, 2);
			...
			this.label75.Location = new System.Drawing.Point(613, 6);
			...
			this.txt_door_key.Location = new System.Drawing.Point(461, 150);
			...
			this.txt_door_key.Size = new System.Drawing.Size(147, 25);
			this.txt_door_key.TabIndex = 14;
			// 
			// label76
			// 
			this.label76.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.label76.AutoSize = true;
			this.label76.Location = new System.Drawing.Point(379, 154);
			...
			this.txt_ignition_key.Location = new System.Drawing.Point(461, 120);
			...
			this.txt_ignition_key.Size = new System.Drawing.Size(147, 25);
			this.txt_ignition_key.TabIndex = 13;
			// 
			// label78
			// 
			this.label78.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.label78.AutoSize = true;
			this.label78.Location = new System.Drawing.Point(379, 124);
			...
			this.num_engine_cc.Location = new System.Drawing.Point(461, 91);
			...
			this.label70.Location = new System.Drawing.Point(379, 95);
			...
			this.txt_engine_no.Location = new System.Drawing.Point(461, 61);
			...
			this.txt_engine_no.Size = new System.Drawing.Size(147, 25);
			this.txt_engine_no.TabIndex = 10;
			// 
			// label68
			// 
			...
			this.label68.Location = new System.Drawing.Point(379, 65);
			...
			this.txt_year_make.Location = new System.Drawing.Point(461, 31);
			...
			this.txt_year_make.Size = new System.Drawing.Size(147, 25);
			this.txt_year_make.TabIndex = 9;
			// 
			// label79
			// 
			this.label79.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this.label79.AutoSize = true;
			this.label79.Location = new System.Drawing.Point(379, 35);
			...
			this.txt_chassis.Location = new System.Drawing.Point(461, 2);
			this.txt_chassis.Margin = new System.Windows.Forms.Padding(2);
			this.txt_chassis.MaxLength = 20;
			this.txt_chassis.Name = "txt_chassis";
			this.txt_chassis.Size = new System.Drawing.Size(147, 25);
			this.txt_chassis.TabIndex = 8;
			...
			this.label67.Location = new System.Drawing.Point(379, 6);
			...
			// 
			// tabpage_loan_details
			// 
			this.tabpage_loan_details.Controls.Add(this.btn_clear_loan_finance);
			this.tabpage_loan_details.Controls.Add(this.btn_loan_finance);
			this.tabpage_loan_details.Controls.Add(this.dtp_loan_settlement_date);
			this.tabpage_loan_details.Controls.Add(this.txt_loan_branch);
			this.tabpage_loan_details.Controls.Add(this.num_installment_day);
			this.tabpage_loan_details.Controls.Add(this.num_installment_amount);
			this.tabpage_loan_details.Controls.Add(this.num_loan_finance_id);
			this.tabpage_loan_details.Controls.Add(this.num_loan_balance);
			this.tabpage_loan_details.Controls.Add(this.txt_loan_agreement_no);
			this.tabpage_loan_details.Controls.Add(this.txt_loan_finance);
			this.tabpage_loan_details.Controls.Add(this.label20);
			this.tabpage_loan_details.Controls.Add(this.label19);
			this.tabpage_loan_details.Controls.Add(this.label18);
			this.tabpage_loan_details.Controls.Add(this.label17);
			this.tabpage_loan_details.Controls.Add(this.label16);
			this.tabpage_loan_details.Controls.Add(this.label15);
			this.tabpage_loan_details.Controls.Add(this.label11);
			this.tabpage_loan_details.Location = new System.Drawing.Point(4, 26);
			this.tabpage_loan_details.Name = "tabpage_loan_details";
			this.tabpage_loan_details.Padding = new System.Windows.Forms.Padding(3);
			this.tabpage_loan_details.Size = new System.Drawing.Size(935, 546);
			this.tabpage_loan_details.TabIndex = 6;
			this.tabpage_loan_details.Text = "Loan details";
			this.tabpage_loan_details.UseVisualStyleBackColor = true;
			// 
			...
			this.txt_loan_branch.TabIndex = 4;
			// 
			// num_installment_day
			// 
			...
			this.num_installment_day.TabIndex = 6;
			...
			this.num_installment_amount.TabIndex = 5;
			...
			this.num_loan_finance_id.TabIndex = 3;
			...
			this.txt_loan_agreement_no.TabIndex = 8;
			// 
			// txt_loan_finance
			// 
			...
			this.groupBox4.Controls.Add(this.toolstrip_payment_to_seller);
			...
			// cms_payment
			// 
			this.cms_payment.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.addPaymentToolStripMenuItem,
            this.editPaymentToolStripMenuItem,
            this.deletePaymentToolStripMenuItem});
			this.cms_payment.Name = "cms_expenses";
			this.cms_payment.Size = new System.Drawing.Size(108, 70);
			// 
			// addPaymentToolStripMenuItem
			// 
			this.addPaymentToolStripMenuItem.Name = "addPaymentToolStripMenuItem";
			this.addPaymentToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.addPaymentToolStripMenuItem.Text = "Add";
			this.addPaymentToolStripMenuItem.Click += new System.EventHandler(this.Btn_add_payment_Click);
			// 
			// editPaymentToolStripMenuItem
			// 
			this.editPaymentToolStripMenuItem.Name = "editPaymentToolStripMenuItem";
			this.editPaymentToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.editPaymentToolStripMenuItem.Text = "Edit";
			this.editPaymentToolStripMenuItem.Click += new System.EventHandler(this.Btn_edit_payment_Click);
			// 
			// deletePaymentToolStripMenuItem
			// 
			this.deletePaymentToolStripMenuItem.Name = "deletePaymentToolStripMenuItem";
			this.deletePaymentToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.deletePaymentToolStripMenuItem.Text = "Delete";
			this.deletePaymentToolStripMenuItem.Click += new System.EventHandler(this.Btn_delete_payment_Click);
			// 
			// toolstrip_payment_to_seller
			// 
			this.toolstrip_payment_to_seller.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
			this.toolstrip_payment_to_seller.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.btn_add_payment,
            this.btn_edit_payment,
            this.btn_delete_payment,
            this.toolStripLabel3,
            this.lbl_total_payment});
			this.toolstrip_payment_to_seller.Location = new System.Drawing.Point(3, 21);
			this.toolstrip_payment_to_seller.Name = "toolstrip_payment_to_seller";
			this.toolstrip_payment_to_seller.Size = new System.Drawing.Size(917, 25);
			this.toolstrip_payment_to_seller.TabIndex = 1;
			this.toolstrip_payment_to_seller.Text = "toolStrip2";
			// 
			// btn_add_payment
			// 
			...
			this.lbl_total_payment.Size = new System.Drawing.Size(28, 22);
			this.lbl_total_payment.Text = "0.00";
			// 
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.grd_expenses);
			this.groupBox1.Controls.Add(this.toolstrip_expenses);
			...
			this.grd_expenses.ContextMenuStrip = this.cms_expenses;
			...
			// cms_expenses
			// 
			this.cms_expenses.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.addExpensesToolStripMenuItem,
            this.editExpensesToolStripMenuItem,
            this.deleteExpensesToolStripMenuItem});
			this.cms_expenses.Name = "cms_expenses";
			this.cms_expenses.Size = new System.Drawing.Size(108, 70);
			// 
			// addExpensesToolStripMenuItem
			// 
			this.addExpensesToolStripMenuItem.Name = "addExpensesToolStripMenuItem";
			this.addExpensesToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.addExpensesToolStripMenuItem.Text = "Add";
			this.addExpensesToolStripMenuItem.Click += new System.EventHandler(this.Btn_add_expenses_Click);
			// 
			// editExpensesToolStripMenuItem
			// 
			this.editExpensesToolStripMenuItem.Name = "editExpensesToolStripMenuItem";
			this.editExpensesToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.editExpensesToolStripMenuItem.Text = "Edit";
			this.editExpensesToolStripMenuItem.Click += new System.EventHandler(this.Btn_edit_expenses_Click);
			// 
			// deleteExpensesToolStripMenuItem
			// 
			this.deleteExpensesToolStripMenuItem.Name = "deleteExpensesToolStripMenuItem";
			this.deleteExpensesToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.deleteExpensesToolStripMenuItem.Text = "Delete";
			this.deleteExpensesToolStripMenuItem.Click += new System.EventHandler(this.Btn_delete_expenses_Click);
			// 
			// toolstrip_expenses
			// 
			this.toolstrip_expenses.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
			this.toolstrip_expenses.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
			...
			this.toolstrip_expenses.Location = new System.Drawing.Point(3, 21);
			this.toolstrip_expenses.Name = "toolstrip_expenses";
			this.toolstrip_expenses.Size = new System.Drawing.Size(917, 25);
			this.toolstrip_expenses.TabIndex = 1;
			this.toolstrip_expenses.Text = "toolStrip1";
			// 
			// btn_add_expenses
			// 
			...
			// 
			this.txt_image_description.Enabled = false;
			this.txt_image_description.Location = new System.Drawing.Point(674, 27);
			...
			this.txt_image_description.Size = new System.Drawing.Size(255, 151);
			...
			this.groupBox7.Size = new System.Drawing.Size(433, 223);
			...
			this.txt_remark.Size = new System.Drawing.Size(427, 199);
			this.txt_remark.TabIndex = 2;
			// 
			// groupBox8
			// 
			this.groupBox8.Controls.Add(this.grd_image);
			this.groupBox8.Controls.Add(this.toolstrip_images);
			this.groupBox8.Location = new System.Drawing.Point(461, 235);
			...
			this.grd_image.ContextMenuStrip = this.cms_image;
			...
			this.cms_image.Size = new System.Drawing.Size(108, 26);
			// 
			// deleteImageToolStripMenuItem
			// 
			this.deleteImageToolStripMenuItem.Name = "deleteImageToolStripMenuItem";
			this.deleteImageToolStripMenuItem.Size = new System.Drawing.Size(107, 22);
			this.deleteImageToolStripMenuItem.Text = "Delete";
			this.deleteImageToolStripMenuItem.Click += new System.EventHandler(this.Btn_delete_image_Click);
			// 
			// toolstrip_images
			// 
			...
			this.toolstrip_images.Location = new System.Drawing.Point(3, 21);
			this.toolstrip_images.Name = "toolstrip_images";
			this.toolstrip_images.Size = new System.Drawing.Size(462, 25);
			this.toolstrip_images.TabIndex = 2;
			this.toolstrip_images.Text = "toolStrip3";
			// 
			// btn_add_image
			// 
			...
			this.btn_delete_image.Text = "Delete";
			this.btn_delete_image.Click += new System.EventHandler(this.Btn_delete_image_Click);
			// 
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.grd_file_attachment);
			this.groupBox3.Controls.Add(this.toolstrip_file_attachment);
			...
			this.grd_file_attachment.AllowUserToResizeRows = false;
			...
			this.grd_file_attachment.ContextMenuStrip = this.cms_attachment;
			...
			this.grd_file_attachment.ReadOnly = true;
			this.grd_file_attachment.RowHeadersVisible = false;
			this.grd_file_attachment.Size = new System.Drawing.Size(443, 252);
			this.grd_file_attachment.TabIndex = 3;
			this.grd_file_attachment.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.Grd_file_attachment_CellDoubleClick);
			// 
			// cms_attachment
			// 
			...
			this.cms_attachment.Name = "cms_image";
			this.cms_attachment.Size = new System.Drawing.Size(129, 48);
			// 
			...
			this.downloadToolStripMenuItem.Click += new System.EventHandler(this.Btn_download_attachment_Click);
			// 
			// deleteAttachmentToolStripMenuItem
			// 
			this.deleteAttachmentToolStripMenuItem.Name = "deleteAttachmentToolStripMenuItem";
			this.deleteAttachmentToolStripMenuItem.Size = new System.Drawing.Size(128, 22);
			this.deleteAttachmentToolStripMenuItem.Text = "Delete";
			this.deleteAttachmentToolStripMenuItem.Click += new System.EventHandler(this.Btn_delete_attachment_Click);
			// 
			// toolstrip_file_attachment
			// 
			this.toolstrip_file_attachment.GripStyle = System.Windows.Forms.ToolStripGripStyle.Hidden;
			this.toolstrip_file_attachment.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.btn_add_attachment,
            this.btn_delete_attachment,
            this.btn_download_attachment});
			this.toolstrip_file_attachment.Location = new System.Drawing.Point(3, 21);
			this.toolstrip_file_attachment.Name = "toolstrip_file_attachment";
			this.toolstrip_file_attachment.Size = new System.Drawing.Size(443, 25);
			this.toolstrip_file_attachment.TabIndex = 2;
			this.toolstrip_file_attachment.Text = "toolStrip3";
			// 
			// btn_add_attachment
			// 
			...
			this.btn_add_attachment.Text = "Add";
			this.btn_add_attachment.Click += new System.EventHandler(this.Btn_add_attachment_Click);
			// 
			...
			this.btn_delete_attachment.Text = "Delete";
			this.btn_delete_attachment.Click += new System.EventHandler(this.Btn_delete_attachment_Click);
			// 
			// btn_download_attachment
			// 
			this.btn_download_attachment.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.btn_download_attachment.Image = global::VehicleDealership.Properties.Resources.Download_16x;
			this.btn_download_attachment.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btn_download_attachment.Name = "btn_download_attachment";
			this.btn_download_attachment.Size = new System.Drawing.Size(23, 22);
			this.btn_download_attachment.Text = "Download";
			this.btn_download_attachment.Click += new System.EventHandler(this.Btn_download_attachment_Click);
			// 
			// picbox_image
			// 
			this.picbox_image.BackColor = System.Drawing.Color.Black;
			this.picbox_image.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.picbox_image.Location = new System.Drawing.Point(461, 7);
			this.picbox_image.Name = "picbox_image";
			this.picbox_image.Size = new System.Drawing.Size(207, 222);
			...
			this.tableLayoutPanel2.Location = new System.Drawing.Point(750, 4);
			...
			this.table_finance.ResumeLayout(false);
			this.table_finance.PerformLayout();
			...
			this.table_acquire_details.ResumeLayout(false);
			this.table_acquire_details.PerformLayout();
			...
			this.table_vehicle_details.ResumeLayout(false);
			this.table_vehicle_details.PerformLayout();
			...
			this.tabpage_loan_details.ResumeLayout(false);
			this.tabpage_loan_details.PerformLayout();
			...
			this.cms_payment.ResumeLayout(false);
			this.toolstrip_payment_to_seller.ResumeLayout(false);
			this.toolstrip_payment_to_seller.PerformLayout();
			this.groupBox1.ResumeLayout(false);
			this.groupBox1.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.grd_expenses)).EndInit();
			this.cms_expenses.ResumeLayout(false);
			this.toolstrip_expenses.ResumeLayout(false);
			this.toolstrip_expenses.PerformLayout();
			...
			this.toolstrip_file_attachment.ResumeLayout(false);
			this.toolstrip_file_attachment.PerformLayout();
		...
		private System.Windows.Forms.ToolStrip toolstrip_expenses;
		...
		private System.Windows.Forms.ToolStrip toolstrip_payment_to_seller;
		...
		private System.Windows.Forms.ToolStrip toolstrip_file_attachment;
		...
		private System.Windows.Forms.TabPage tabpage_loan_details;
		...
		private System.Windows.Forms.TableLayoutPanel table_vehicle_details;
		...
		private System.Windows.Forms.TableLayoutPanel table_finance;
		...
		private System.Windows.Forms.TableLayoutPanel table_acquire_details;
		...
		private System.Windows.Forms.TextBox txt_sale_order;
		...
		private System.Windows.Forms.OpenFileDialog filedlg_attachment;
		...
		private System.Windows.Forms.ToolStripButton btn_download_attachment;
		private System.Windows.Forms.ToolStripMenuItem downloadToolStripMenuItem;
		private System.Windows.Forms.ContextMenuStrip cms_expenses;
		private System.Windows.Forms.ContextMenuStrip cms_payment;
		...
		private System.Windows.Forms.ToolStripMenuItem editExpensesToolStripMenuItem;
		...
		private System.Windows.Forms.TextBox txt_prev_reg_no;
